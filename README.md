...
run `.\src\ovenreader.py` from the package directory. At the prompt, you will
enter the target filepath. The example file can be used for testing purposes
as follows:
...
**\*\*NOTE\*\*** \
_Users may need to run `python .\src\ovenreader.py` depending on their config._
***
